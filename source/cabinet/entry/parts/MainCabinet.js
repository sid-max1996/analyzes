...
export default {
    ...
    methods: {
        fetchCabinetInfo: function() {
            return data.fetchStore(store, 'setCabinetInfo', methods.fetchCabinetInfo);
        },
        fetchAnketaInfo: function() {
            return data.fetchStore(store, 'setAnketaInfo', methods.fetchAnketaInfo);
        },
        fetchSettingsInfo: function() {
            return data.fetchStore(store, 'setSettingsInfo', methods.fetchSettingsInfo);
        },
        fetchAdminInfo: function(params) {
            ...
            return data.fetchStore(store, 'setAdminInfo', methods.fetchAdminInfo, {
                roleId: this.roleId,
                pageNum: pageNum,
                rowCount: rowCount,
                filter: filter
